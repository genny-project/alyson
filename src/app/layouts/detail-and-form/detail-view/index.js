    ...
    <Grid w="60vw" bg={bg} spacing={4} p="5" overflowY="scroll" top="10vh" gap={'1em'}>
      ...
      >
        ...
        >
          ...
          <Details label="LinkedIn" locationCode={''} currentMentor={beCode} miniCard />
          <Details label="Hobbies" locationCode={''} currentMentor={beCode} miniCard />
        </VStack>
        <VStack
          boxShadow="base"
          rounded="md"
      ...
      >
        ...
        <Details label="" locationCode={''} currentMentor={beCode} miniCard />
      </VStack>
    </Grid>
  )
}
...
const DetailView = ({ beCode }) => {
  ...
  const detailViewPcmCode = find(includes('_DETAIL_VIEW'))(allPcmCode)
