          ...
          <Grid w="100%" templateRows="repeat(9, 1fr)" templateColumns="repeat(3, 1fr)" gap={6}>
            ...
            <GridItem rowSpan={1} colSpan={1}>
              <VStack align="start">
                ...
                <Attribute code={beCode} attribute={`_LNK_INTERNSHIP__LNK_DRESS_CODE__PRI_NAME`} />
              </VStack>
            </GridItem>
            <GridItem rowSpan={2} colSpan={2}>
              <VStack align="start">
            ...
            <GridItem rowSpan={1} colSpan={3}>
              <VStack align="start">
                ...
                <Attribute
                  code={beCode}
                  attribute={`_LNK_INTERNSHIP__LNK_SOFTWARE__PRI_NAME`}
                  config={{ detailViewTags: true }}
                />
              </VStack>
            </GridItem>
          ...
          <Grid w="100%" templateRows="repeat(3, 1fr)" templateColumns="repeat(3, 1fr)" gap={6}>
            ...
            <GridItem rowSpan={1} colSpan={1}>
              <VStack align="start">
                ...
                <Attribute
                  code={beCode}
                  attribute={`_LNK_INTERNSHIP__LNK_HOST_COMPANY__PRI_ADDRESS_FULL`}
                />
              </VStack>
            </GridItem>
          </Grid>
